import { PublicKey, TransactionInstruction, SystemProgram, Keypair, SYSVAR_RECENT_BLOCKHASHES_PUBKEY, Connection, LAMPORTS_PER_SOL } from "@solana/web3.js"
import { SolanaNftStaking } from "./idl/solana_nft_staking"
import { LootboxProgram } from "./idl/lootbox_program"
import { Program, BorshInstructionCoder, BN } from "@project-serum/anchor"
import { PermissionAccount, ProgramStateAccount, OracleQueueAccount, SwitchboardProgram } from "@switchboard-xyz/switchboard-v2"
